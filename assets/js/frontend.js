...
(function(root, factory) {
  ...
  BEM.prototype.getBlock = function($this) {
    ...
    return $this.closest('.' + blockClass);
  };
  ...
  BEM.prototype.switchBlock = function($this, block, elem) {
    ...
    elem
      ? this.buildSelector({ block: block, elem: elem })
      : this.buildSelector({ block: block });
  ...
  BEM.prototype.findElem = function($this, elemKey) {
    ...
    return $this.is(elemSelector) ? $this : $this.find(elemSelector);
  };
  ...
  BEM.prototype.getBaseClass = function($this) {
    ...
    $.each(selectors, function(i, sel) {
      ...
      if (baseClass==null && classType && classType != 'mod') {
        baseClass = sel;
      }
    });
  ...
  $.fn.extend({
    ...
    byNotMod: function(modKey, modVal) {
      return $.BEM.byMod(this, modKey, modVal, true);
    },
